...
func (t *CreditCardRepositoryDb) CreateCreditCard(creditCard domain.CreditCard) error {
	...
	_, err = stmt.Exec(
		...
		creditCard.Name,
		creditCard.Number,
		creditCard.ExpiretionMonth,
		creditCard.ExpiretionYear,
		creditCard.CVV,
		creditCard.Balance,
		creditCard.Limit,
	)
...
func (t *CreditCardRepositoryDb) GetCreditCard(creditCard domain.CreditCard) (domain.CreditCard, error) {
...
func (t *CreditCardRepositoryDb) updateBalance(creditCard domain.CreditCard) error {
