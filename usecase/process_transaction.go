...
import (
	...
	"github.com/brandaoplaster/payment-gateway/dto"
	"github.com/brandaoplaster/payment-gateway/infrastructure/kafka"
)
...
func (useCaseTransaction UseCaseTransaction) newTransaction(transaction dto.Transaction, creditCard domain.CreditCard) *domain.Transaction {
